...
type exampleService struct {
	exampleMySqlRepository domain.ExampleMySQlRepositoryContact
}

func NewExampleService(mysql domain.ExampleMySQlRepositoryContact) domain.ExampleServiceContact {
